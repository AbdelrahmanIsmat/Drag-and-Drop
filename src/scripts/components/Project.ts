...
export class Project extends Base<HTMLDivElement> {
  ...
  private _deleteProject(): void {
    ...
    deleteButton.addEventListener("click", this._handlerDeleteProject);
  }
  /**
   * @desc delete check user confirm delete ? get function to delete this project
   */
  @autoBind
  private _handlerDeleteProject(): void {
